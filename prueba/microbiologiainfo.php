...
<?php
    $conexion=mysqli_connect('localhost','root','','batch_record');
?>
              ...
              <div class="card-body">
                ...
                <table>
                  ...
                  <select class="selectpicker form-control sel_equipos" id="sel_incubadora" id="otro">
                    <option value="value1"selected>SELECCION EQUIPO1</option>
                    <option value="value2">SELECCION EQUIPO2</option>
                    <option value="value3">SELECCION EQUIPO3</option>
                  </select>
                  <select class="selectpicker form-control sel_equipos" id="sel_autoclave">
                    <option value="value1"selected>AUTOCLAVE1</option>
                    <option value="value2">AUTOCLAVE2</option>
                    <option value="value3">AUTOCLAVE3</option>
                  </select>
                  <select class="selectpicker form-control sel_equipos" id="sel_cabina">
                    <option value="value1"selected>TIPO DE EQUIPO1</option>
                    <option value="value2">TIPO DE EQUIPO2</option>
                    <option value="value3">TIPO DE EQUIPO3</option>
                  </select>
